...
Função para a validação de um anagrama. Utilizei a função 'replace' para padronizar as palavras e um 'sorted' para verificar se as palavras contém as mesmas letras e a mesma quantidade de letras.
```python
